	...
	var BaseSearchScreen = BaseScreen.extend(
		{
			...
			getSearchUrl: function() { throw 'getSearchUrl() must be implemented'; },
			getSearchResults: function() { throw 'getSearchResults() must be implemented'; },
			getSearchResultUrl: function() { throw 'getSearchResultUrl() must be implemented'; },
			getSearchResultStatus: function() { throw 'getSearchResultStatus() must be implemented'; },
			getSearchResultText: function() { throw 'getSearchResultUrl() must be implemented'; }
		}, {
			MODE_SEARCH: 'search',
